...
extern PROTOBUF_INTERNAL_EXPORT_test_5f_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_test_5f_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_test_5f_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_test_5f_2eproto;
namespace fixbug {
...
static void InitDefaultsscc_info_GetFriendListRequest_test_5f_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListRequest_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendListRequest_test_5f_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendListResponse_test_5f_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListResponse_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListResponse_test_5f_2eproto}, {
      &scc_info_ResultCode_test_5f_2eproto.base,
      &scc_info_User_test_5f_2eproto.base,}};

static void InitDefaultsscc_info_LoginRequest_test_5f_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LoginRequest_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LoginRequest_test_5f_2eproto}, {}};

static void InitDefaultsscc_info_LoginResponse_test_5f_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LoginResponse_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LoginResponse_test_5f_2eproto}, {
      &scc_info_ResultCode_test_5f_2eproto.base,}};

static void InitDefaultsscc_info_ResultCode_test_5f_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ResultCode_test_5f_2eproto}, {}};

static void InitDefaultsscc_info_User_test_5f_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_test_5f_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_User_test_5f_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_test_5f_2eproto[6];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_test_5f_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_test_5f_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_5f_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, err_),
...
const char descriptor_table_protodef_test_5f_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013test_.proto\022\006fixbug\")\n\014LoginRequest\022\014\n"
  ...
  "ug.LoginRequest\032\025.fixbug.LoginResponse\022L"
  "\n\rGetFriendList\022\034.fixbug.GetFriendListRe"
  "quest\032\035.fixbug.GetFriendListResponseb\006pr"
  "oto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_test_5f_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_5f_2eproto_sccs[6] = {
  &scc_info_GetFriendListRequest_test_5f_2eproto.base,
  &scc_info_GetFriendListResponse_test_5f_2eproto.base,
  &scc_info_LoginRequest_test_5f_2eproto.base,
  &scc_info_LoginResponse_test_5f_2eproto.base,
  &scc_info_ResultCode_test_5f_2eproto.base,
  &scc_info_User_test_5f_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_test_5f_2eproto_once;
static bool descriptor_table_test_5f_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_5f_2eproto = {
  &descriptor_table_test_5f_2eproto_initialized, descriptor_table_protodef_test_5f_2eproto, "test_.proto", 564,
  &descriptor_table_test_5f_2eproto_once, descriptor_table_test_5f_2eproto_sccs, descriptor_table_test_5f_2eproto_deps, 6, 0,
  schemas, file_default_instances, TableStruct_test_5f_2eproto::offsets,
  file_level_metadata_test_5f_2eproto, 6, file_level_enum_descriptors_test_5f_2eproto, file_level_service_descriptors_test_5f_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_test_5f_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_test_5f_2eproto), true);
namespace fixbug {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* User_Sex_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_test_5f_2eproto);
  return file_level_enum_descriptors_test_5f_2eproto[0];
}
...
void LoginRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginRequest_test_5f_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void ResultCode::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResultCode_test_5f_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  err_ = 0;
}
...
void LoginResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginResponse_test_5f_2eproto.base);
...
const GetFriendListRequest& GetFriendListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRequest_test_5f_2eproto.base);
  return *internal_default_instance();
}
...
void User::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_User_test_5f_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void GetFriendListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListResponse_test_5f_2eproto.base);
  result_ = nullptr;
}
